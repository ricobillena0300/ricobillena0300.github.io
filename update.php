...
if (isset($_POST['submit'])) {
    ...
    $sql = "update passenger set passenger_id=$passenger_id, passenger_fname='$passenger_fname', passenger_lname='$passenger_lname', passenger_mname='$passenger_mname', passenger_email='$passenger_email', passenger_phone='$passenger_phone' where passenger_id=$passenger_id";
...
<body>
    ...
    <section class="contact-us">
     ...
     <label for="passenger_id"></label>
        ...
        <input type='text' name='passenger_lname' id="passenger_lname" required placeholder="PASSSENGER LAST NAME"> <br> <br><br>
